  ...
  return (
    <Stack gap="md" maw={900}>
      ...
      <Text size="sm" c="dimmed">
        A PO typed in by hand (phone order, walk-in). It is created active and marked
        edited, so the extraction pipeline never touches it.
      </Text>
        ...
        <Table>
          ...
          <Table.Tbody>
            {items.map((it, i) => (
              <Table.Tr key={it._rk}>
                <Table.Td>
                  <TextInput size="xs" value={it.product_name ?? ""} onChange={(e) => setItem(i, "product_name", e.currentTarget.value)} />
                </Table.Td>
                <Table.Td w={80}>
